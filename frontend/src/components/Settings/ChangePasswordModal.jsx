...
const ChangePasswordModal = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Не удалось сменить пароль. Проверьте текущий пароль.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const styles = {
    ...
    success: { color: '#43b581', fontSize: '13px', marginBottom: '12px' },
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={styles.body}>
            ...
            {success && <div style={{ ...styles.success, marginTop: '12px' }}>Пароль успешно изменён ✓</div>}
          </div>
